...
用法（需要 torch + safetensors 的解释器，见 memory environment-reference）：
    python dump_torch_ref.py [--ckpt 路径] [--out 目录]
"""
...
REPO = Path(__file__).resolve().parents[2]          # .../AnimaLoraToolkit
