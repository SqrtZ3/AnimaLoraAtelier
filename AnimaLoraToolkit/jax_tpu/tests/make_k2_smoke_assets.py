...
ROOT = Path("D:/Datasets/_staging")
DATA = ROOT / "krea2-tiny-data"
MODEL = ROOT / "krea2-tiny-model"
...
def main() -> int:
    ...
    meta_data = {"title": "krea2-tiny-data", "id": "ilovebg/krea2-tiny-data",
                 "licenses": [{"name": "other"}]}
    meta_model = {"title": "krea2-tiny-model", "id": "ilovebg/krea2-tiny-model",
                  "licenses": [{"name": "other"}]}
